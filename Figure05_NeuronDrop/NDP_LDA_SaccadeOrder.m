%% Liner Discriment Analysis for saccade order with neuron drop procedure
...
%% decoding section
        ...
        for tdrop = 1:size(feaMat,2) % neuron dropping
            ...
            decodeSac_CovMatrix.(VarName).(EpochName{ep}){tdrop,blk} = CovMatrix;
            toc;
        end
        end
    end
...
% save('decodeSac_NeuronDrop.mat','decodeSac_CovMatrix');clear decodeSac